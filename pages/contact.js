                            ...
                            <ul className="flex flex-row flex-wrap mt-3 ml-10">
                                <li className={"mx-2"}>
                                    <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/starts_ian">
                                        <div className="p-3 align-middle bg-white border-4 w-16 h-16"
                                ...
                                <li className={"mx-2"}>
                                    <a target="_blank" rel="noopener noreferrer"
                                       href="https://www.linkedin.com/in/yoni-kok-b0885813a/">
                                        <div className="p-4 align-middle bg-white border-4 w-16 h-16"
                                             style={{borderRadius: '100%', borderColor: '#9600ff'}}>
                                            <LinkedIn/>
                                        </div>
                                    </a>
